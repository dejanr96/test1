...
SYMBOL = "ETH/USDT:USDT" # Testing on ETH

async def run_backtest():
    print(f"--- 🚀 STARTING MULTI-COIN BACKTEST: {SYMBOL} ---")
    ...
    print(f"Fetching 10,000 candles for {SYMBOL} starting from 30 days ago...")
    
    # Note: 'binanceusdm' supports ETH/USDT:USDT
    data_service = DataIngestionService(exchange_id='binanceusdm', symbol=SYMBOL, timeframe='1m')
    ...
    # 5. Load the Saved Normalization Statistics (FROM BTC TRAINING)
    # This is the "Universal Strategy" test. Can BTC stats work on ETH?
    ...
    try:
        ...
        while True:
            ...
            if dones[0]:
                ...
                print("\n" + "="*40)
                print(f"🏁 MULTI-COIN BACKTEST FINISHED ({SYMBOL})")
